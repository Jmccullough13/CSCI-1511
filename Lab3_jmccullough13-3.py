...
#Jeffrey McCullough
#This is a program that will display a list of items to be packed for a camping trip. A previously added item is replaced with a new item and the list is reprinted.
#January 22, 2023
